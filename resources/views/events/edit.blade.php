        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0"><i class="bi bi-pencil-square"></i> Edit Event</h3>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('events.update', $event) }}" method="POST" class="needs-validation">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="datetime-local" class="form-control @error('event_datetime') is-invalid @enderror" 
                                       ...
                                       value="{{ old('event_datetime', $event->event_datetime->format('Y-m-d\TH:i')) }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @error('total_seats')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted d-block mt-1">Available seats: <strong>{{ $event->available_seats }}</strong></small>
                            </div>
                        </div>
